...
const events = [
  ...
  { number: 3, codename: "BUZZ BUILDERS", title: "Social Media Marketing Campaign", venue: "Room No. 2", time: "11.30 AM – 1.30 PM", floor: "Ground Floor", color: "#3498db", accent: "#72c6ff", icon: "/icons/buzzbuilders.png", illustration: "/icons/socialmediamarketing campaighn.png", coordinator: { name: "Mr. Sanath Kotian", phone: "8618051932" } },
  ...
  { number: 5, codename: "SAY IT SMART", title: "Caption Writing Contest", venue: "Room No. 1", time: "10.30 AM – 11.30 AM", floor: "Ground Floor", color: "#f39c12", accent: "#ffd166", icon: "/icons/sayitsmart.png", illustration: "/icons/captionwritingcontest.png", coordinator: { name: "Ms. Akshatha Nayak", phone: "9380703282" } },
  { number: 6, codename: "60 SECONDS FAME", title: "Reel Making", venue: "Computer Lab 1", time: "3.00 PM – 4.00 PM", floor: "First Floor", color: "#e91e8c", accent: "#ff6ec7", icon: "/icons/fame.png", illustration: "/icons/reelmaking.png", coordinator: { name: "Ms. Nayana Naik", phone: "7338621700" } },
